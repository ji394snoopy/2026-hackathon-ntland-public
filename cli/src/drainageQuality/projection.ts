...
// TWD97 TM2 zone 121 (EPSG:3826) — confirmed identical projection parameters across all
// 4 WRA layers this module reads, despite differing PROJCS vendor labels
// ("TWD97_TM2_zone_121" vs "TWD_1997_TM_Taiwan"): central meridian 121°E, false easting
// 250000, false northing 0, scale factor 0.9999, on the GRS80 ellipsoid/TWD97 datum.
const TWD97_TM2_DEF =
...
// per lookup, not per polygon/line vertex, since every WRA layer's native geometry is
// already in this CRS and is left untouched.
